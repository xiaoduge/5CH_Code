...
{  
    ...
    sAD7799_WriteRegEx(0,AD7799_MAKE_REG(AD7799_WADDR_CONFIG),Cmd,2); 
    
    Cmd[0] = CovMode;  
    Cmd[1] = CovRate;  
    sAD7799_WriteRegEx(0,AD7799_MAKE_REG(AD7799_WADDR_MODE),Cmd,2);  
}  
...
{  
    ...
    uint32_t D;  
    Cmd[0]=0;  
    sAD7799_ReadRegEx(0,AD7799_MAKE_REG(AD7799_RADDR_DATA),&Cmd[1],3);  
