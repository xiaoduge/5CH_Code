#ifndef _AD7799_MULTI_DRIVER_H_
#define _AD7799_MULTI_DRIVER_H_
...
void mAD7799_Write_Bytes(uint8_t ucChl,uint8_t *data,uint8_t len);
void mAD7799_Read_Bytes(uint8_t ucChl,uint8_t *data,uint8_t len);
void mAD7799_Init(int spi);
void mAD7799_ReadReg(uint8_t ucChl,uint8_t RegAddr,uint8_t *Buffer,uint8_t Length);  
void mAD7799_WriteReg(uint8_t ucChl,uint8_t RegAddr,uint8_t *Buffer,uint8_t Length);  
void mAD7799_ReadRegEx(uint8_t ucChl,uint8_t bcsSwitch,uint8_t RegAddr,uint8_t *Buffer,uint8_t Length); 
void mAD7799_WriteRegEx(uint8_t ucChl,uint8_t bcsSwitch,uint8_t RegAddr,uint8_t *Buffer,uint8_t Length);  

uint8_t mAD7799_WaitBusy(uint8_t ucChl) ; 
void mAD7799_Cs(uint8_t ucChl,int enable);
uint8_t mAD7799_GetBusyState(uint8_t ucChl);  
uint8_t mAD7799_Calibrate(uint8_t ucChl,uint8_t CHx,uint8_t Gain) ; 
void mAD7799_Reset(uint8_t ucChl);
