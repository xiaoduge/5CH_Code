...
void sAD7799_ReadRegEx(uint8_t bcsSwitch,uint8_t RegAddr,uint8_t *Buffer,uint8_t Length); 
void sAD7799_WriteRegEx(uint8_t bcsSwitch,uint8_t RegAddr,uint8_t *Buffer,uint8_t Length);  

uint8_t sAD7799_WaitBusy(void) ; 
int sAD7799_Install_WaitBusy_Callback(dica_event_callback handle,void *para,int trigs);
