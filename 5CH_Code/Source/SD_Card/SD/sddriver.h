...
================================================================================
*/
void SD_SetLogLevel(int iLevel);
...
Input   : -log level
            -filename, lineno  and format
Output  : None
Note    : None        
================================================================================
*/
int SD_logger(int level,char *filename,int lineno,const char* fmt,...);

#define SD_LOG(level,fmt, args...)   SD_logger(level, __FILE__, __LINE__,fmt,##  args)

#define DEBUG_SD_INFO(fmt, args...)   SD_logger(SD_LOG_DEBUG, __FILE__, __LINE__,fmt,##  args)
